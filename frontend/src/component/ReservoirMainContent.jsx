...
import Score from './charts/Score.jsx';
        ...
        <main className="mt-3 w-full max-w-[1393px] max-md:mr-2.5 max-md:max-w-full gap-20">
            ...
            <div className="flex gap-20 max-md:flex-col">
                ...
                <div className="flex flex-col w-full max-md:ml-0 max-md:w-full">
                    <div className="grow w-10/12 max-md:mt-10 max-md:max-w-full">
                ...
                {/* RIGHT */}
                {/* <div className="flex flex-col ml-5 w-10/12 max-md:ml-0 max-md:w-full">
